...
int main() {
   ...
   */
  vector<double> p = {0.155, 0.00105, 1.7};   // initial p vector

  vector<double> dp = {0.001, 0.001, 0.1}; // dp vector
  ...
  int n_end = 500;                        // where to end to calculate loss and restart the simulator
